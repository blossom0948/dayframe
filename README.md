...
같은 저장소의 루트에는 Cloudflare Pages에서 바로 배포할 수 있는 브라우저용 Dayframe 뷰어도 포함되어 있습니다. [CLOUDFLARE_PAGES.md](CLOUDFLARE_PAGES.md)의 Pages 설정을 사용하면 Android 프로젝트와 웹 뷰어를 함께 관리할 수 있습니다.
...
웹에서는 달력·피드·통계·보관함을 둘러보고, 사진 파일을 선택해 새 기록을 만들거나 편집할 수 있습니다. 기록은 브라우저에만 저장되며 보관함에서 JSON으로 백업/복원할 수 있습니다.
